        ...
        <AssistantRuntimeProvider runtime={runtime}>
          <ThreadPrimitive.Root className="flex h-full min-h-0 flex-col overflow-hidden">
            ...
            <ComposerPrimitive.Root className="shrink-0 bg-transparent p-4 pt-1 sm:p-6 sm:pt-2">
              <div className="mx-auto flex w-full max-w-5xl items-end gap-2 rounded-2xl border bg-background/80 p-2 shadow-sm backdrop-blur transition-colors focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/20">
              ...
              <div className="mx-auto mt-2 max-w-5xl text-center text-xs text-muted-foreground/80">
                {isHydratingThread
