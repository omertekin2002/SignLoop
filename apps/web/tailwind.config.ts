...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      typography: {
        // `prose-dala`: assistant markdown in the Dala text colours, via the semantic tokens so it
        // follows the light/dark theme.
        dala: {
          css: {
            "--tw-prose-body": "var(--foreground)",
            "--tw-prose-headings": "var(--foreground)",
            "--tw-prose-lead": "var(--subtle-foreground)",
            "--tw-prose-links": "var(--highlight)",
            "--tw-prose-bold": "var(--foreground)",
            "--tw-prose-counters": "var(--muted-foreground)",
            "--tw-prose-bullets": "var(--muted-foreground)",
            "--tw-prose-hr": "var(--border)",
            "--tw-prose-quotes": "var(--subtle-foreground)",
            "--tw-prose-quote-borders": "var(--primary)",
            "--tw-prose-captions": "var(--muted-foreground)",
            "--tw-prose-code": "var(--foreground)",
            "--tw-prose-pre-code": "var(--subtle-foreground)",
            "--tw-prose-pre-bg": "var(--code-background)",
            "--tw-prose-th-borders": "var(--input)",
