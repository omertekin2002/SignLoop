...
- **Logo:** an Electric Iris triangle fragment fading to Deep Verdant, beside a white "SignLoop" wordmark (`SignLoopWordmark` in `components/dashboard.tsx`). The logo and the constellation are the only gradients.
